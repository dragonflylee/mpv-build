...
download:
	...
	curl --retry 5 -sSL https://ffmpeg.org/releases/ffmpeg-9.0.2.tar.xz | tar Jxf - -C $(TMPDIR)
...
ffmpeg: mbedtls libass dav1d
	...
	$(TMPDIR)/ffmpeg-9.0.2/configure --enable-shared --disable-static --prefix=$(PREFIX) \
